...
export class DurationTestData {
  ...
  constructor(testEventTypes: EventTypeTestData) {
    this.reading_1                 = new DurationEventModel(null)
    ...
    this.yoga_practice_1                 = new DurationEventModel(null)
...
export class OccurrenceTestData {
  ...
  constructor(testEventTypes: EventTypeTestData) {
    this.reading_1                 = new OccurrenceEventModel(null)
    ...
    this.yoga_practice_1                 = new OccurrenceEventModel(null)
